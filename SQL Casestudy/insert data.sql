-- insert data into attach_facility table
...
insert into customer(id,name, birthday, gender, id_card, phone_number, email, address, customer_type_id)
...
-- insert data into customer table
insert into employee(id,name, birthday, id_card, salary, phone_number, email, address, position_id, education_degree_id, division_id)
values
...
('House Princess 01',14000,5000000,10,'vip','Có thêm bếp nướng',null,3,null,2,2),
