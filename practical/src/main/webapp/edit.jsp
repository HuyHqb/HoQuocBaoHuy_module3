...
<table>
<tr>
    <th colspan="2" style="text-align: center; color: red">EDIT</th>
</tr>

<tr>
<td><label for="fn">Mã phòng trọ: </label></td>
<td>
<c:if test="${phongTro !=null}"></c:if>
<input type="text" id="fn" name="maPhongTro" value="<c:out value='${phongTro.id}'>" disabled/>
    </td>
    </tr>
    ...
    <td>
    <input type="text" id="datepicker" name="tenNguoiThue" value="<c:out value='${phongTro.tenNguoiThue}'>"/>
        </td>
        </tr>
        ...
        <input type="text" id="iddc" name="soDienThoai" value="<c:out value='${phongTro.soDienThoai}'>"/>
            </tr>

            <tr>
            <td><label for="pn">Ngày bắt đầu thuê: </label></td>
            <td><input type="date" id="pn" name="ngayBatDau" value="<c:out value='${phongTro.ngayBatDau}'></td>
                </tr>
